# Business Model: Manufacture of refractory products
...
## Classification
- Repository: `cloud-itonami-isic-2391` ([github.com/cloud-itonami/cloud-itonami-isic-2391](https://github.com/cloud-itonami/cloud-itonami-isic-2391))
- ISIC Rev.5: `2391` — Manufacture of refractory products
- Domain: `:refractory-products/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:refractory-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :refractory-products/manufacturing — who wants
...
One managed tenant (:refractory-products/manufacturing):
...
- Do not bypass the `:refractory-plant-operations-governor` for production decisions.
