# Operator Quickstart — Manufacture of refractory products

Shortest path from clone to a verified local dry-run for **ISIC 2391** (`cloud-itonami-isic-2391`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2391.git
cd cloud-itonami-isic-2391
```
...
- Blueprint governor key: `refractory-plant-operations-governor`
- Likely source path: `refractorymfg.governor.cljc`
