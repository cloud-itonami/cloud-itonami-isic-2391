(ns refractorymfg.phase
  "Phase 0->3 staged rollout for the refractory products (fire brick,
  ...
  consequence (a pressing-line/kiln-line-equipment maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `refractorymfg.governor`'s `kiln-line-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Refractory Plant Operations Governor verdict to a base
